...
namespace Skilet
{
    ...
    internal class SkilletBuilderInspector : Editor
    {
        [SerializeField] private VisualTreeAsset transformField;
        [SerializeField] private VisualTreeAsset chracterInterface;

        public const string TRANSFORM_FIELD = "Assets/_Project/Editor/Skilet/TransformField.uxml";
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            descriptionLabel.style.unityTextAlign = TextAnchor.UpperCenter; //TextAlign.Center;
